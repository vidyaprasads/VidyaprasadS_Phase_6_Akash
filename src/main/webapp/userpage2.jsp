	...
	<div>
		<div id="navbar" class="row">
				...
				<div class="col-md-10 col-sm-12" id="searchcontainer">
					<form action="usersearch" method="post" class="form-inline">
					...
					<a href="kart.jsp" style="padding:0 20px;color:#dc3545" id="cart" ><i class="fa fa-cart-plus" style="font-size:30px"></i></a>
					</form>
				</div>
		...
		<div class="row" style="margin:0px;">
			...
			<div class="accordion accordion-flush" id="accordionFlushExample">
  				...
  				<div class="accordion-item">
    				...
    				<div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
						  ...
						  <span><form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><input class="btn btn-outline-secondary" type="submit" name="checkbox" value="Indian"></form>
      							<form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><input class="btn btn-outline-secondary" type="submit" name="checkbox" value="French"></form>
      							<form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><input class="btn btn-outline-secondary" type="submit" name="checkbox" value="Continental"></form>
      							<form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><input class="btn btn-outline-secondary" type="submit" name="checkbox" value="Italian"></form>
      					  </span>	     							
      					</div>
  					</div>
  				</div>	
  				<div class="accordion-item">
    				...
    				<div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
      					<div class="accordion-body">
      					  <span><form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><input class="btn btn-outline-secondary" type="submit" name="checkbox" value="Veg"></form>
      							<form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><input class="btn btn-outline-secondary" type="submit" name="checkbox" value="NonVeg"></form>
      						</span>
      					</div>
  					</div>
  				</div>	
  				<div class="accordion-item">
    				...
    				<div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
      					<div class="accordion-body">
      					  <span><form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><button class="btn btn-outline-secondary" type="submit" name="checkbox" value="5">Discount - 5%</button></form>
      							<form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><button class="btn btn-outline-secondary" type="submit" name="checkbox" value="10">Discount - 5% to 10%</button></form>
      							<form action="userfilter" method="post" style="display:inline-block;padding:5px 0px 0px 0px;"><button class="btn btn-outline-secondary" type="submit" name="checkbox" value="15">Discount - Above 10%</button></form>
      					 </span>	
						</div>
  					</div>
  				</div>	
					...
					<div id="Filter2">
						<div>
							<form action="userfilter2" method="post">
			...
			<div class="col-md-9 col-sm-12" id="itemlist">
				<div id="sort">Sort By :<br> <span><form action="usersort" method="post" style="display:inline-block;padding:0px 10px;"><input type="submit" class="btn btn-danger" name="sort" value="Price"></form>
				<form action="usersort" method="post" style="display:inline-block;padding:10px;"><input type="submit" name="sort" value="Category" class="btn btn-danger"></form>
				<form action="usersort" method="post" style="display:inline-block;padding:10px;"><input type="submit" value="Id" name="sort" class="btn btn-danger"></form>
				</span>
				</div>
					<%
					...
					%>
					<a href="userpage3.jsp?msg=<%=rs.getString("Id") %>" style="text-decoration:none;color:black;">
					<div id="item" class="row">
						...
						<div class="col-md-8 col-sm-12" id="content">
							...
							<div id="order" style="padding:10px; font-family:'Montserrat',sans-serif; border-radius:5px;">Price: <%=rs.getString("Price") %></div>
						</div>			
