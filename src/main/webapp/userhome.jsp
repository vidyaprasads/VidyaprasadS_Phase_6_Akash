...
<body>
        ...
        <div id="imagecontainer">
            ...
            <a href="userpage2.jsp" class="links">Search</a>
            <a href="kart.jsp" class="links">Cart</a>
             <a href="home.jsp" class="links" id="signout"><%=name %></a>
        	</div>
        	<div id="slogn">Eat <br>What <br>You <span style="color:#f54748">Love!</span></div>
         
         	<div id="searchcontainer">
         		<a href="userpage2.jsp"><button class="btn">Search Your Fav Food!</button></a>
         	</div>
         </div>
...
<div id="sec3title">Discouts For U!</div>
	<div class="row">
		<a href="userpage2.jsp?msg=1" class="col-md-4 col-lg-4 box"><div>
		...
		<a href="userpage2.jsp?msg=6" class="col-md-4 col-lg-4 box"><div >
			<div class="card" style="width: 18rem;">
		...
		<a href="userpage2.jsp?msg=2" class="col-md-4 col-lg-4 box"><div >
			<div class="card" style="width: 18rem;">
		...
		<div class="row">
		<a href="userpage2.jsp?msg=3" class="col-md-4 col-lg-4 box"><div >
			<div class="card" style="width: 18rem;">
		...
		<a href="userpage2.jsp?msg=12" class="col-md-4 col-lg-4 box"><div >
			<div class="card" style="width: 18rem;">
		...
		<a href="userpage2.jsp?msg=8" class="col-md-4 col-lg-4 box"><div >
			<div class="card" style="width: 18rem;">
...
<div id="sec2title">Historical Foods</div>
	<div id="imgcontainer">
	<a href="userpage2.jsp?msg=Indian"><div class="row">
		<div class="col-md-12 col-lg-12 img" style="background-image:url('/FoodBox/resources/img/indian.jpg');">
			<div class="msg">
	...
	<a href="userpage2.jsp?msg=Italian"><div class="row">
		<div class="col-md-12 col-lg-12 img" style="background-image:url('/FoodBox/resources/img/Italian.jpg');">
				<div class="msg">
			<div class="title">Italian</div>
				<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p></div>
		</div>
		</div></a>
	<a href="userpage2.jsp?msg=French"><div class="row">
		<div class="col-md-12 col-lg-12 img" style="background-image:url('/FoodBox/resources/img/Franch.jpg');">
				<div class="msg">
